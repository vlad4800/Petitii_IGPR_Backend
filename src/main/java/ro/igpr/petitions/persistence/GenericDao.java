package ro.igpr.petitions.persistence;
    ...
    public final static SessionFactory getSessionFactory() {
        ...
        if (sessionFactory == null) {
            try {
                ...
                final File configFile = new File("config/" + ro.igpr.petitions.config.Configuration.getEnvironmentName() + "/hibernate.cfg.xml");
